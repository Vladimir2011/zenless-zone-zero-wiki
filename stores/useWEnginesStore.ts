...
export const useWEnginesStore = defineStore('WEnginesStore', {
      ...
      wEnginesList: [
        {
          ...
          breadcrumbs: [
            ...
            {
              name: 'Храм вьюги',
              link: '/wiki/wengines/hailstorm-shrine'
            }
          ],
          name: 'Храм вьюги',
          description:
            '<p class="wengine-description-text">Истребляй, истребляй, истребляй. Убивай, руби, карай: такова судьба прóклятой. Так колотится в тебе запретная сила. И лишь между битвами, пока ты бежишь от одного поля боя к другому, лисье пламя находит краткий покой в этом храме.\n' +
            'Сколько ещё нужно истребить? Сколько ещё нужно принести в жертву? Сколько ещё бедствий нужно пережить, пока ты не перейдёшь на ту сторону небытия?\n' +
            'Тебе не нужен ответ. Ты достигла вершины мастерства: ты не вдыхаешь запаха крови — он застывает в морозном воздухе, не добравшись до носа. Когда ты уничтожишь всё зло, ты вложишь меч в ножны, и тогда мир погрузится в безмятежный сон.\n' +
            'Мёрзлый снег бьёт в окна храма, и обладательница великой силы просыпается. Грядёт вьюга.\n' +
            '\n' +
            '«Превосходно для практики... было бы, если бы я могла уменьшиться до нужного размера», — <a class="wengine-agent-link" style="display: inline; color: #eec554; font-weight: 700" href="/wiki/characters/miyabi">Мияби,</a> рассматривающая внутреннее убранство храма и бормочущая себе под нос.</p>',
          slug: 'hailstorm-shrine',
          link: '/wiki/wengines/hailstorm-shrine',
          image: 'hailstorm-shrine.webp',
          icons: {
          ...
          skill:
            '<p class="wengine-skill-text">Крит. урон повышен на <b style="color: #eec554">50/57/65/72/80%.</b> Когда агент с этим предметом выполняет усиленную особую атаку или когда любой член отряда накладывает на врага аномалию атрибута, агент с этим предметом наносит на <b style="color: #eec554">20/23/26/29/32%</b> больше <span style="color: #98eff0">ледяного урона.</span> Эффект складывается до <b style="color: #eec554">2 ур.</b>, длится <b style="color: #eec554">15 сек.</b> Время действия каждого уровня рассчитывается отдельно.</b></p>',
          rarity: 'S',
          specialty: 'attack',
          signature: {
            name: 'Мияби',
          ...
          characters: [
            {
              ...
              name: 'Мияби',
              link: '/wiki/characters/miyabi',
              image: 'miyabi/miyabi-small-card-image.webp',
              icons: {
        ...
        },
        {
          ...
          breadcrumbs: [
            ...
            {
              name: 'Аптечка дзансин',
              link: '/wiki/wengines/zanshin-herb-case'
            }
          ],
          name: 'Аптечка дзансин',
          description:
            '<p class="wengine-description-text">Лекарство — не добрая и не злая вещь. Оно лишь устраняет некоторые эффекты болезни и даёт свои побочные.\n' +
            'Горечь лекарства не смущает воина. Его конец пути давно предрешён: значит, чтобы стрела могла долететь до светлой дали, надо испить горькую чашу с лекарством до дна.\n' +
            '\n' +
            '«Есть одно лекарство — отлично подходит, чтобы симулировать болезнь. Кратковременно повышает температуру: главное, ни с чем другим его не смешивать. Только оно дорогое, и по страховке его не выдают», — <a class="wengine-agent-link" style="display: inline; color: #eec554; font-weight: 700" href="/wiki/characters/harumasa">Харумаса</a>, делящийся лайфхаками о том, как прогуливать работу.</p>',
          slug: 'zanshin-herb-case',
          link: '/wiki/wengines/zanshin-herb-case',
          image: 'zanshin-herb-case.webp',
          icons: {
            rarity: 'rarity-s.webp',
          ...
          skill:
            '<p class="wengine-skill-text">Шанс крит. попадания возрастает на <b style="color: #eec554">10/11,5/13/14,5/16%.</b> Атака в рывке наносит на <b style="color: #eec554">40/46/52/58/64%</b> больше <span style="color: #2eb6ff">электрического урона.</span> Когда любой член отряда вводит врага в состояние оглушения или аномалии атрибута, шанс крит. попадания у агента с этим предметом возрастает ещё на <b style="color: #eec554">10/11,5/13/14,5/16% на 15 сек.</b></p>',
          rarity: 'S',
          specialty: 'attack',
          signature: {
            name: 'Харумаса',
          ...
          characters: [
            {
              ...
              name: 'Харумаса',
              link: '/wiki/characters/harumasa',
              image: 'harumasa/harumasa-small-card-image.webp',
              icons: {
        ...
        },
        {
          ...
          breadcrumbs: [
            ...
            {
              name: 'Пламенный венец',
              link: '/wiki/wengines/blazing-laurel'
            }
          ],
          name: 'Пламенный венец',
          description:
            '<p class="wengine-description-text">Свирепый амплификатор, оснащённый сифонной трубой, выпускающей пламя — превосходное дополнение к граду кулачных ударов. Говорят, что внутри содержится горючая жидкость, которую в древности использовала некая империя в морских сражениях. Состав этой жидкости был давно утерян, и восстановить его практически невозможно!\n' +
            '\n' +
            '«Вообще-то я всего лишь просил запасную зажигалку», — <a class="wengine-agent-link" style="display: inline; color: #eec554; font-weight: 700" href="/wiki/characters/lighter">Лайтер</a>, комментирующий опыт использования этого ценного топлива.</p>',
          slug: 'blazing-laurel',
          link: '/wiki/wengines/blazing-laurel',
          image: 'blazing-laurel.webp',
          icons: {
            rarity: 'rarity-s.webp',
          ...
          skill:
            '<p class="wengine-skill-text">При запуске быстрой помощи или идеальной помощи у агента с этим предметом импульс увеличивается на <b style="color: #eec554">25/28,75/32,5/36,25/40%</b> на <b style="color: #eec554">8 сек.</b> Когда агент с этим предметом попадает по врагу базовой атакой, на цель накладывается <b style="color: #eec554">1 ур. Подавленности.</b> Эффект длится <b style="color: #eec554">30 сек.</b> и суммируется до <b style="color: #eec554">20 раз.</b> Повторные запуски обновляют время действия. Когда любой персонаж в отряде попадает по врагу, за каждый уровень <b style="color: #eec554">Подавленности</b> у цели, <span style="color: #98eff0">ледяной</span> и <span style="color: #ff5521">огненный</span> <b style="color: #eec554">Крит. урон</b> увеличиваются на <b style="color: #eec554">1,5/1,72/1,95/2,17/2,4%.</b> Эффект един для всего отряда.</p>',
          rarity: 'S',
          specialty: 'stun',
          signature: {
            name: 'Лайтер',
          ...
          characters: [
            {
              ...
              name: 'Лайтер',
              link: '/wiki/characters/lighter',
              image: 'lighter/lighter-small-card-image.png',
              icons: {
        ...
        },
        {
          ...
          breadcrumbs: [
            ...
            {
              name: 'Ткач времени',
              link: '/wiki/wengines/timeweaver'
            }
          ],
          name: 'Ткач времени',
          description:
            '<p class="wengine-description-text">Созданный по заказу Секции 6 ССК амплификатор со встроенным суперкомпьютером. Обеспечивает самые точные расчёты и анализ, что позволяет агенту ясно определять план действий. В амплификатор встроены драгоценные часы <a class="wengine-agent-link" style="display: inline; color: #eec554; font-weight: 700" href="/wiki/characters/yanagi">Янаги</a>, но каждый раз при включении эфирные потоки закручивают стрелки, так что сверять по нему время невозможно. Это стоит иметь в виду всякому, кто отправляется на задание вместе с <a class="wengine-agent-link" style="display: inline; color: #eec554; font-weight: 700" href="/wiki/characters/yanagi">Янаги:</a> если она говорит, что надо спешить и вы выбиваетесь из графика, — не стоит ей верить.\n' +
            '\n' +
            '«Говоришь, это устройство идеально подходит, чтобы убивать время? И правда: раз стрелки движутся так быстро, можно сказать, что время убивается... Но ведь время в реальном мире от движения стрелок не ускоряется? Значит, оно убивает время с той же скоростью, как и любые другие часы...»,\n' +
            '— <a class="wengine-agent-link" style="display: inline; color: #eec554; font-weight: 700" href="/wiki/characters/yanagi">Цукисиро Янаги</a>, с железобетонной серьёзностью отвечающая на глупую шутку своего коллеги.</p>',
          slug: 'timeweaver',
          link: '/wiki/wengines/timeweaver',
          image: 'timeweaver.webp',
          icons: {
            rarity: 'rarity-s.webp',
            specialty: 'anomaly-specialty.webp'
          },
          ...
          skill:
            '<p class="wengine-skill-text">Агент с этим предметом накапливает аномалию <span style="color: #2eb6ff">электрического атрибута</span> на <b style="color: #eec554">30/35/40/45/50%</b> быстрее. Когда <b style="color: #eec554">особая или усиленная особая атака</b> попадает по врагу, находящемуся в состоянии аномалии атрибута, знание аномалии агента с этим предметом повышается на <b style="color: #eec554">75/85/95/105/115 ед. на 15 сек.</b>\n' +
            'Если знание аномалии агента с этим предметом не менее <b style="color: #eec554">375 ед.</b>, агент с этим предметом наносит на<b style="color: #eec554"> 25/27,5/30/32,5/35%</b> больше урона от <b style="color: #eec554">Хаоса.</b></p>',
          rarity: 'S',
          specialty: 'anomaly',
          signature: {
            name: 'Янаги',
          ...
          characters: [
            {
              ...
              name: 'Янаги',
              link: '/wiki/characters/yanagi',
              image: 'yanagi/yanagi-small-card-image.webp',
              icons: {
                attribute: 'electric-attribute.webp',
                specialty: 'anomaly-specialty.webp'
              },
        ...
        },
        {
          ...
          breadcrumbs: [
            ...
            {
              name: 'Маркато-реверб',
              link: '/wiki/wengines/marcato-desire'
            }
          ],
          name: 'Маркато-реверб',
          description:
            '<p class="wengine-description-text">Сила искусства может вытащить человека со дна. Смертные сходятся вместе, сплетаются музыкальные темы, им вторит буйство красок граффити на стенах.\n' +
            'Пора выкрутить звук на полную — пусть басы заставят каверну дрожать. Может, у эфириалов и нет ушей, но оглушить их это нам не помешает!</p>',
          slug: 'marcato-desire',
          link: '/wiki/wengines/marcato-desire',
          image: 'marcato-desire.webp',
          icons: {
          ...
          skill:
            '<p class="wengine-skill-text">Когда усиленная особая атака или цепочка атак попадает по врагу, сила атаки агента с этим предметом на <b style="color: #eec554">8 сек.</b> увеличивается на <b style="color: #eec554">6/6,9/7,8/8,7/9,6%.</b> Сила атаки увеличивается дополнительно на <b style="color: #eec554">6/6,9/7,8/8,7/9,6%</b>, если цель находится в состоянии аномалии атрибута.</p>',
          rarity: 'A',
          specialty: 'attack',
          signature: null,
          characters: [
  ...
  actions: {
    ...
    filterWEnginesList() {
      this.filteredWEnginesList = this.wEnginesList.filter((wEngine: any) => {
    ...
    getWEngineByRouteSlug(slug: string) {
      return this.wEnginesList.find((engine: any) => engine.slug === slug)
    },
